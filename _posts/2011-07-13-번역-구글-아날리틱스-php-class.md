...
tags:
  - PHP
description: 이제 이 클래스는 작동하지 않는다. 구글 아날리틱스의 API는 오래 전에 바뀌었다. 
image: /uploads/legacy/ga-marbles.jpg
date_modified: 2017-04-04 01:36
---

## 2017-04-03

위에 써놨듯, 이제 이 클래스는 작동하지 않는다. [최신 API](https://developers.google.com/analytics/)를 참고하라. 

기회가 되면 최신 API를 바탕으로 웹사이트에 구글 아날리틱스 통계를 넣는 방법을 소개하도록 하겠다.
...
2009-07-15에 덧붙임: 구글은 GA의 새로운 API를 출시했다. 리턴받는 데이터 양에 제한이 생겼고, dimensions 와 metrics 조합에 느슨한 제약이 생겼다.
 ...
 [2]: http://www.askaboutphp.com/2009/05/29/google-analytics-api-class-for-php/
