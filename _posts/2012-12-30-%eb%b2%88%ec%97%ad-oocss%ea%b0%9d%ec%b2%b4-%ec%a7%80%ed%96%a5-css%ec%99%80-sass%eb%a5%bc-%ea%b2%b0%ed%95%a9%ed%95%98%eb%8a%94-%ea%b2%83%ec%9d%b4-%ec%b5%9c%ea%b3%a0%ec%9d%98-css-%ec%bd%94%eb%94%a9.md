...
tags:
  ...
  - OOCSS
---
얼마 전 [객체 지향 CSS 소개][1]를 번역했다. 그리고 [진우 님이 댓글로 글을 두 개 소개해 줬다.][2] 그 중 하나를 번역했다. OOCSS의 단점을 지적하면서 그 단점을 보완할 수 있는 방법을 소개하는 글이다.
...
<div class="simple-footnotes">
 ...
 [1]: http://mytory.local/archives/8949 "[번역] 객체 지향 CSS(OOCSS) 소개"
