...
tags:
  - SVG 활용
  - 마법 나무 테마
date_modified: 2017-03-30 23:19
---
...
내가 사용하는 SVG를 모두 gzip으로 압축하면 28kb가 나오는데, SVG를 인라인으로 박은 경우에 10페이지 보면 속절없이 280kb가 소모된다. 이 탓에 블로그를 인라인 SVG로 개편한 뒤 계속 트래픽이 초과됐다.
...
~~~
<object data="vector-img.svg" type="image/svg+xml"></object>
~~~

~~~
<embed src="vector-img.svg" type="image/svg+xml">
~~~

~~~
<iframe src="vector-img.svg"></iframe>
~~~
