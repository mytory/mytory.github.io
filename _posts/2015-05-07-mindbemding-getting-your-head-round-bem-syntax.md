...
짚고 가야 할 것은, 내가 BEM에 _기반한_ 작명 규칙을 사용하지만, 그것은 [니콜라스 갤러거가 발전시킨 것](http://nicolasgallagher.com/about-html-semantics-front-end-architecture/)([번역](http://mytory.net/2016/12/02/about-html-semantics-front-end-architecture.html))이라는 점이다.
