...
라라벨은 꽤 최근에 나온 프레임웍이다. 허용하는 PHP 최하 버전은 5.5.9로, 워드프레스나 코드 이그니터보다 요구사항이 꽤 높다. Composer 같은 현대적 도구들을 적극 사용하는 것은 당연하다. 실제로 또다른 PHP 프레임웍인 [Sympony](https://symfony.com/)의 모듈들을 많이 가져와 사용하고 있다.
